...
- [x] **Step 1: Implement idempotent collection and object helpers**
...
- [x] **Step 2: Implement GLB import and normalization**
...
- [x] **Step 3: Validate module syntax**
...
- [x] **Step 1: Build the layered corridor**
...
- [x] **Step 2: Build three broad-gauge tracks**
...
- [x] **Step 3: Build platform and overhead electrification context**
...
- [x] **Step 4: Validate module syntax**
...
- [x] **Step 1: Port and refine both approved cabinet structures**
...
- [x] **Step 2: Import and normalize the line-scan enclosure**
...
- [x] **Step 3: Add trigger sensors and animated scan planes**
...
- [x] **Step 4: Build underground foundations and conduit**
...
- [x] **Step 5: Validate module syntax**
...
- [x] **Step 1: Import normalized WAP-7 and LHB assets**
...
- [x] **Step 2: Assemble three compact consists**
...
- [x] **Step 3: Animate the foreground train**
...
- [x] **Step 4: Add locomotive headlights**
...
- [x] **Step 1: Configure day and night lighting**
...
- [x] **Step 2: Create six named cameras**
...
- [x] **Step 5: Save, render, and export**
...
- [x] **Step 6: Validate all module syntax**
...
- [x] **Step 1: Build headlessly in Blender 5.2.2**
...
- [x] **Step 2: Inspect the rendered preview**
...
- [x] **Step 3: Load the saved `.blend` and re-run dimension assertions**
...
- [x] **Step 4: Load the exported GLB in the Three.js build**
